...
export const GrapeIcon = ({ size = 20 }: { size?: number }) => {
  return (
    <svg
      height={size}
      viewBox="0 0 58 58"
    ...
    >
      <path
        fillRule="evenodd"
        clipRule="evenodd"
        d="M46.106,13.556C48.517,10.361,50,6.14,50,1.5h-2c0,8.601-5.547,15.619-12.468,15.967c-0.784-0.461-1.663-0.772-2.602-0.898
...
export const VerifiedIcon = ({ size = 16 }: { size?: number }) => {
  return (
